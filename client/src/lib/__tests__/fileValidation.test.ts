...
describe("validateFileSize", () => {
  ...
  describe("emoji validation", () => {
    it("rejects emoji files larger than 256KB", () => {
      const largeEmoji = new File([new ArrayBuffer(300 * 1024)], "large.gif", {
        type: "image/gif",
      });
    ...
    it("accepts emoji files within 256KB limit", () => {
      const smallEmoji = new File([new ArrayBuffer(200 * 1024)], "small.gif", {
        type: "image/gif",
      });
    ...
    it("accepts emoji at exactly 256KB", () => {
      const exactEmoji = new File([new ArrayBuffer(256 * 1024)], "exact.gif", {
        type: "image/gif",
      });
