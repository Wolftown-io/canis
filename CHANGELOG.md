...
### Added
- Channel message pinning — pin up to 50 messages per channel with PIN_MESSAGES permission, pin/unpin from message context menu, pin indicator on messages, pin drawer sidebar with jump-to-message, pin count badge in channel header, and system messages for pin/unpin actions
